...
<div class="container">
<div class="row">
<p>Books | <a href="Novels.php">Novels</a></p>
</div>
...
<form method="POST" action="Novels.php" class="d-md-flex">
  ...
  <div class="row cat ">
   ...
   if(isset($_POST['searchcat'])&&($_POST['searchType'])=="BookName"){?>
       ...
       $search=$_POST['searchcat'];
        $sql="SELECT * FROM book WHERE  book_name like '%$search%' AND category_id=2";
...
<div class="col-lg-9 col-md-9 col-sm-12">
      ...
      <?php  
       ...
       <?php  }}else{
        ...
        if (isset($_GET['author_id'])) {
            ...
            $result="SELECT * FROM book WHERE author_id=$author_id and category_id=2";
            $resproductall=$db1->query($result);
        }
        else
        {
            $result="SELECT * FROM book WHERE category_id=2";
            $resproductall=$db1->query($result);
 ...
 <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
    	...
    	<li style="list-style: none" class="list-group-item list-group-item-info">
    	 	<b><a href="Novels.php" style="text-decoration:none;color:black">Show all Authors</a></b> 
    	</li>
    
   
    	<?php                           
                            $sql='SELECT * From author WHERE category_id=2 ORDER BY author_name';
                            ...
                            if($result){
                                foreach ($result as $rows){?>
                                	<li style="list-style:none" class="list-group-item">
                                		<a href="Novels.php?author_id=<?php echo $rows['author_id']?>" style="text-decoration:none;">
