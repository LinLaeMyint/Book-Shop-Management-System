...
<div class="container">
<div class="row">
<p>Home | <a href="Adminhome.php">Show All Books</a> | <a href="AdminSearchbar.php">Search Result</a></p>
</div>
...
<div class="col-lg-9 col-md-9 col-sm-12">
 ...
 <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
    	...
    	<li style="list-style: none" class="list-group-item list-group-item-info">
    	 	<b><a href="AdminSearchbar.php" style="text-decoration:none;color:black">Show all Authors</a></b> 
    	</li>
                            ...
                            if($result){
                                foreach ($result as $rows){?>
                                	<li style="list-style:none" class="list-group-item">
                                		<a href="AdminSearchbar.php?author_id=<?php echo $rows['author_id']?>" style="text-decoration:none;">
