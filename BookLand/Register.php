    ...
    if ($_POST["adminpassword"] == $_POST["adminconfirmpassword"]) {
        try {
            if(filter_var($usremail, FILTER_VALIDATE_EMAIL)) {
                ...
                if(preg_replace("/[^A-Za-z0-9]/","",$_POST['adminusername'])){
        ...
        if(isset($usrname)&&isset($usremail)&&isset($usrpsw)){
            ...
            if( $usrrole="Admin")
            {
                header('Location: Adminhome.php?user_id=' . $uid);
...
<br><br>
    ...
    <div class="row mb-3">
            		...
            		<div class="col-sm-8">
            		    <input type="password" class="form-control form-control-lg" name="adminconfirmpassword" required/>
            		</div>
    </div>  
<br>
    <div class="mb-4">
                  ...
                  <p class="mb-5 pb-lg-2" style="color: black;">Already have an account? <a href="Login.php">Login here</a></p>
                </form>
</body>
</html>