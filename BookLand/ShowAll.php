...
<div class="container">
<div class="row">
<p>Books | <a href="ShowAll.php">Show All Books</a></p>
</div>
...
<form method="POST" action="ShowAll.php" class="d-md-flex">
...
<div class="col-lg-9 col-md-9 col-sm-12">
 ...
 <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
    	...
    	<li style="list-style: none" class="list-group-item list-group-item-info">
    	 	<b><a href="ShowAll.php" style="text-decoration:none;color:black">Show all Authors</a></b> 
    	</li>
                            ...
                            if($result){
                                foreach ($result as $rows){?>
                                	<li style="list-style:none" class="list-group-item">
                                		<a href="ShowAll.php?author_id=<?php echo $rows['author_id']?>" style="text-decoration:none;">
