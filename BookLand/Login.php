...
<br>
    <div class="mb-4">
                    <input class="btn btn-dark btn-lg" type="submit" name="login" style="float:right" value="Login">
    </div>               
                  <p class="mb-5 pb-lg-2" style="color: white;">Don't have an account? <a href="Register.php">Register here</a></p>
                </form>
